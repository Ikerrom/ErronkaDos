...
public class SQLserverKonfigurazioa {
    ...
    @Bean
    public ErosketaDao getErosketaDao() {
    	return new ErosketaDao();
    }
    @Bean
    public BezeroaDao getBezeroaDao() {
    	return new BezeroaDao();
    }
    @Bean
    public FakturaDao getFakturaDao() {
    	return new FakturaDao();
    }
    @Bean
    public SalmentaDao getSalmentaDao() {
    	return new SalmentaDao();
    }
   
    @Bean
    public ProduktuaDao getProduktuaDao() {
    	return new ProduktuaDao();
    }
